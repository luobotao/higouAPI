...
public class NoticeRequest {
	...
	private KuaidiResult lastResult = new KuaidiResult();
	...
	public KuaidiResult getLastResult() {
		return lastResult;
	}

	public void setLastResult(KuaidiResult lastResult) {
	...
	public static void main(String[] args) {
		...
		req.getLastResult().getData().add(item);
		System.out.println(JacksonHelper.toJSON(req.getLastResult().getData()));
	}
